...
export default function SignUpPage() {
    ...
    return (
        <div>
            <div>
                <form action={signUpAction} className="flex flex-col items-center justify-center h-screen gap-4">
                    <input type="text" name="name" placeholder="Name" required className={inputStyle}></input>
